 ...
 * 		(1)Finished on Jan 11 2015.
 * 		(3)
 * 		(4)
 * 		All finished on
 */

public class Color_Temperature_v2{	
	...
	public static double[] XYZforWhitePoint(){
		...
		double[][] CIExyz = CIExyz();
	  	...
	  	*/
  		...
  		//Y value
  		xyzWhitePoint[0] = tempxyz[0]*k;
  		xyzWhitePoint[1] = tempxyz[1]*k;
  		xyzWhitePoint[2] = tempxyz[2]*k;
	...
	public static void Object_CMYK_Spectral_Display(){
		...
		JFrame frame = new JFrame("Object_CMYK Spectral Display for "+space+" Color Space.");
